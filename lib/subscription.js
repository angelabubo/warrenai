...
export const confirmCardPayment = async (stripe, paymentIntent, paymentMethodId) => {
  try {
...
export  const handleCustomerActionRequired = async (stripe, {
  subscription,
  invoice,
  priceId,
  paymentMethodId,
  ...
  if (
    ...
    try {
      const result = await confirmCardPayment(stripe, paymentIntent, paymentMethodId);
...
export const processSubscriptionRequest = async (userId, priceId, paymentMethod) => {
